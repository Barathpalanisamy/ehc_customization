...
ehc_customization.HierarchyChart = class {
	...
	*/
	...
	show() {
		...
		let me = this;
		let hasValue = (
			this.page.main.find('[data-fieldname="company"]').val() ||
			this.page.main.find('[data-fieldname="designation"]').val() ||
			this.page.main.find('[data-fieldname="department"]').val() ||
			this.page.main.find('[data-fieldname="branch"]').val() ||
			this.page.main.find('[data-fieldname="employee"]').val()
		);
